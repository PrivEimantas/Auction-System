    ...
    public static void main(String[] args) {
       ...
       public void generateNewToken(Client client){
        ...
        try {
          ...
          System.out.println("getting a challenge exception");
          e.printStackTrace();
          // TODO: handle exception
        }
      ...
      public void setEmail(String myemail){
       ...
       public void register(Auction server,Client client){
        ...
        userId=server.register(email,clientsidePublicKey); //pass in key but DONT use
       ...
       public void getSpec(Auction server,Client client){
        ...
        try {
          ...
          if(client.getUserId()!=null){ // user must register first..
            AuctionItem specItem= server.getSpec(client.getUserId(),inp,"TOKEN");
       ...
       public void newAuction(Auction server,Client client){
        ...
        if(client.getUserId()!=null){
          ...
          auctionID = server.newAuction(client.getUserId(), newItem,"TOKEN"); // add token as argument to each one now
       ...
       public void listItems(Auction server,Client client){
        try {
          if(client.getUserId()!=null){ //check if a user has registered yet.. otherwise dont
            AuctionItem[] items = server.listItems(userId,"TOKEN");
            // TODO: handle exception
             if(items==null){
       ...
       public void bid(Auction server,Client client){
        ...
        try {
          if(client.getUserId()!=null){ //checking if a user has registered yet
            ...
            Boolean bidding = server.bid(userid,auctionId,bidAmount,"TOKEN");
       ...
       public void closeAuction(Auction server,Client client){
          ...
          Integer inp = Integer.parseInt(o.nextLine());
          try {
            AuctionResult closedAuctionResult= server.closeAuction(client.getUserId(),inp,"TOKEN");
       ...
       public String generateChallenge(){ // DONT USE
       ...
       public PublicKey readServerPublicKey(){ // DONT USE
